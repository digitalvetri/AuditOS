...
await shot('/hrms/documents', 'mod-documents-fw');
await shot('/hrms/employees', 'mod-employees-fw');
await shot('/hrms/attendance', 'mod-attendance-fw');
await shot('/hrms/payroll', 'mod-payroll-fw');
await browser.close();
