...
const TYPES = [
  ...
  { code: 'llp', name: 'LLP Registration', shortName: 'LLP', kind: 'entity',
    ...
    portalUrl: 'https://www.mca.gov.in/content/mca/global/en/mca/llp-e-filling.html', portalLabel: 'MCA Portal · Ministry of Corporate Affairs',
  ...
  { code: 'pf', name: 'PF Registration', shortName: 'PF', kind: 'labour',
    ...
    portalUrl: 'https://www.epfo.gov.in/', portalLabel: 'EPFO · Ministry of Labour & Employment',
